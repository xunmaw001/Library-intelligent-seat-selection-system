		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑选座信息</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>编辑选座信息</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">选座信息信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>图书馆类型</label>
										<input name="tushuguanleixing" id="tushuguanleixing" name="tushuguanleixing" class="form-control" placeholder="图书馆类型">
									</div>
									<div class="form-group col-md-6">
										<label>位置</label>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "xuanzuoxinxi/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("xuanzuoxinxi/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("xuanzuoxinxi/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("xuanzuoxinxi/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
			...
			function fill(){
				...
				http(accountTableName+'/session','GET',{},(res)=>{
					if(res.code == 0){
						...
						if(res.data !=null && res.data.shoujihao != null && res.data.shoujihao != ''){
		...
		function dataBind(){
			...
			$("#tushuguanleixing").val(ruleForm.tushuguanleixing);	
			...
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.tushuguanleixing != null && res.data.tushuguanleixing != ''){
						...
						$("#tushuguanleixing").val(res.data.tushuguanleixing);
						$("#tushuguanleixing").attr('readonly','readonly');
					}
